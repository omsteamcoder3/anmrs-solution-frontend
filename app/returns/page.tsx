      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[rgb(223,115,14)] mx-auto mb-4"></div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6 flex items-center">
              <div className="w-2 h-8 bg-[rgb(223,115,14)] mr-3 rounded-full"></div>
              Our Strict Policy
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {returnsPolicy.returnSteps.map((step, index) => (
                <div key={index} className="border border-gray-200 rounded-xl p-6 hover:border-[rgb(223,115,14)] transition-colors">
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {returnsPolicy.conditions.map((requirement, index) => (
                    <div 
                      key={index} 
                      className="bg-[rgb(223,115,14)] text-white px-3 py-2 rounded-md hover:bg-[rgb(189,75,0)] transition-all duration-200 font-medium shadow text-sm text-center cursor-pointer"
                    >
                      {requirement}
                    </div>
                  ))}
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <div className="bg-gray-100 p-4 rounded-lg border-l-4 border-[rgb(223,115,14)]">
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <div className="mt-4 p-3 bg-[rgb(223,115,14)] text-white rounded-md text-center font-medium">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col space-y-3">
                  <Link
                    href="/contact"
                    className="bg-[rgb(223,115,14)] text-white px-4 py-3 rounded-md hover:bg-[rgb(189,75,0)] transition-all duration-200 font-medium shadow hover:shadow-lg text-center text-sm cursor-pointer"
                  >
          ...
          <div className="text-center">
            <Link
              href="/"
              className="inline-flex items-center px-6 py-3 bg-[rgb(223,115,14)] text-white font-medium rounded-lg hover:bg-[rgb(189,75,0)] transition-all duration-200 hover:shadow-lg text-sm cursor-pointer"
            >
              Back to Home
            </Link>
          </div>
