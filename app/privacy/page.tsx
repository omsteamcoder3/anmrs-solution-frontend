      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
            <div className="bg-[rgb(223,115,14)] text-white px-3 py-1.5 rounded-md text-sm font-medium">
              ...
              {settings?.dataWeCollect && settings.dataWeCollect.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  {settings.dataWeCollect.map((point, index) => (
                    <div 
                      key={index} 
                      className="bg-[rgb(223,115,14)] text-white px-3 py-2 rounded-md hover:bg-[rgb(189,75,0)] transition-all duration-200 font-medium shadow text-sm text-center"
                    >
                      {point}
                    </div>
                  ))}
          ...
          <section className="mt-10">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              <div className="flex items-start">
                <svg className="w-6 h-6 text-[rgb(223,115,14)] mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col space-y-3">
                  <Link
                    href="/contact"
                    className="bg-[rgb(223,115,14)] text-white px-4 py-3 rounded-md hover:bg-[rgb(189,75,0)] transition-all duration-200 font-medium shadow hover:shadow-lg text-center"
                  >
