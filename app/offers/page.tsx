        ...
        {error && !loading && (
          <div className="text-center py-12">
            ...
            <button
              ...
              className="bg-[#008080] text-white px-6 py-2 rounded-lg hover:bg-[rgb(129,52,0)] transition-colors"
            >
              Try Again
            </button>
          </div>
          ...
          <>
            ...
            {filteredProducts.length === 0 ? (
              <div className="text-center py-16">
                ...
                <Link
                  href="/products"
                  className="inline-block bg-[#008080] text-white px-6 py-2 rounded-lg hover:bg-[rgb(129,52,0)] transition-colors"
                >
                  Browse All Products
                </Link>
              </div>
