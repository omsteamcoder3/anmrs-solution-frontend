      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <section className="mb-10">
            ...
            <div className="mb-8 p-4 bg-orange-50 border border-orange-200 rounded-lg">
              <div className="flex items-center">
                <svg className="w-6 h-6 text-[rgb(223,115,14)] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {/* Domestic Standard */}
              <div className="border border-gray-200 rounded-xl p-6 hover:border-[rgb(223,115,14)] transition-colors">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-[rgb(223,115,14)] rounded-lg flex items-center justify-center mr-4">
              ...
              {/* Overnight Shipping */}
              <div className="border border-gray-200 rounded-xl p-6 hover:border-[rgb(223,115,14)] transition-colors md:col-span-2">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-[rgb(223,115,14)] rounded-lg flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <div className="space-y-3">
                <div className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 text-[rgb(223,115,14)] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center">
            <Link
              href="/"
              className="inline-flex items-center px-6 py-3 bg-[rgb(223,115,14)] text-white font-medium rounded-lg hover:bg-[rgb(189,75,0)] transition-all duration-200 hover:shadow-lg"
            >
