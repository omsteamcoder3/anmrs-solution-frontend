        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              minLength={6}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-600 focus:border-orange-600 transition-all duration-200"
          ...
          {message && (
            <div className={`p-3 rounded-md ${
              message.includes('successfully') 
                ? 'bg-orange-600/10 text-orange-800 border border-orange-600/20' 
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-4 py-2 bg-orange-600 text-white rounded-md hover:bg-orange-700 transition-all duration-200 font-medium disabled:opacity-50 cursor-pointer"
            >
