        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sm:p-8 space-y-6 sm:space-y-8">
            <div className="text-center">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[rgb(223,89,0)] mx-auto"></div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sm:p-8 space-y-6 sm:space-y-8">
            ...
            <p className="mt-2 text-gray-600 text-lg lg:text-base">
              {isGuestUser ? (
                ...
                <>
                  ...
                  <Link
                    href="/login"
                    className="font-semibold text-[rgb(223,89,0)] hover:text-orange-700 transition-colors duration-200"
                  >
                    Sign in
                  </Link>
                </>
          ...
          <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
            ...
            {isGuestUser && !showPasswordFields && (
              <div className="bg-[rgb(223,89,0)]/10 border border-[rgb(223,89,0)]/20 text-orange-800 px-3 py-3 rounded-lg text-xs sm:text-sm flex items-start">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(223,89,0)] focus:border-[rgb(223,89,0)] transition-all duration-200 placeholder-gray-400"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(223,89,0)] focus:border-[rgb(223,89,0)] transition-all duration-200 placeholder-gray-400 disabled:bg-gray-50 disabled:text-gray-500"
            ...
            <div>
              {isGuestUser && !showPasswordFields ? (
                <button
                  ...
                  className="w-full bg-[rgb(223,89,0)] text-white py-3 sm:py-4 rounded-lg hover:bg-orange-700 transition-all duration-200 font-medium shadow-lg hover:shadow-gray-900/25 text-sm sm:text-base cursor-pointer"
                >
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-[rgb(223,89,0)] text-white py-3 sm:py-4 rounded-lg hover:bg-orange-700 transition-all duration-200 font-medium shadow-lg hover:shadow-gray-900/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center text-sm sm:text-base cursor-pointer"
                >
                  {isLoading ? (
            ...
            {isGuestUser && showPasswordFields && (
              <div className="text-center">
                <button
                  ...
                  className="text-xs sm:text-sm text-[rgb(223,89,0)] hover:text-orange-700 font-medium transition-colors duration-200 cursor-pointer"
                >
                  ← Back to basic info
                </button>
              </div>
